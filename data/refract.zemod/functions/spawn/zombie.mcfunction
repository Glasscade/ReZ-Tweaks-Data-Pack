...
# Axe Zombie
execute if score mobcounter rez_zombie matches 2 run summon zombie ~ ~ ~ {Tags:["axe_zombie", "nocusmob"],HandItems:[{id:"minecraft:stone_axe",Count:1b,tag:{AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:3,Operation:0,UUID:[I;1514701916,916669999,-1829732926,360915514],Slot:"mainhand"}]}},{id:"minecraft:stone_axe",Count:1b}],HandDropChances:[0.000F,0.000F],ArmorItems:[{id:"minecraft:leather_boots",Count:1b},{},{id:"minecraft:leather_chestplate",Count:1b},{}],ArmorDropChances:[0.085F,0.085F,0.085F,0.000F],Attributes:[{Name:generic.follow_range,Base:64},{Name:generic.movement_speed,Base:0.2}]}
